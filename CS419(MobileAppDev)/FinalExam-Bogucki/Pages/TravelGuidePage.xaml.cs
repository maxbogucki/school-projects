...
public partial class TravelGuidePage : ContentPage, IQueryAttributable
{
    public required string URL { get; set; }
    public TravelGuidePage()
    {
        InitializeComponent();
    ...
    private void OnWebViewNavigating(object sender, WebNavigatingEventArgs e)
    {
        ...
        TravelGuideWebView.IsVisible = false;
    }
    ...
    private void OnWebViewNavigated(object sender, WebNavigatedEventArgs e)
    {
        ...
        TravelGuideWebView.IsVisible = true;
    }
}