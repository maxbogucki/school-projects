...
// 
// Max Bogucki, CS318, P03
// This project solves simple operations with complex numbers
...
int main()
{
	...
	// 1. Test addition of two complex numbers
	cout << "Test 1 - Addition of complex numbers\n\n";
	assertx((z1 + z2) == complex(3, 4), __LINE__);

	// 2. Test subtraction of two complex numbers
	cout << "Test 2 - Subtraction of complex numbers\n\n";
	assertx((z1 - z2) == complex(1, 2), __LINE__);

	// 3. Test multiplication of two complex numbers
	cout << "Test 3 - Multiplication of complex numbers\n\n";
	assertx((z1 * z2) == complex(-1, 5), __LINE__);

	// 4. Test division of two complex numbers
	cout << "Test 4 - Division of complex numbers\n\n";
	assertx((z1 / z2) == complex(2.5, 0.5), __LINE__);

	// 5. Test addition assignment operator
	z1 += z2;
	cout << "Test 5 - Addition assignment of complex numbers\n\n";
	assertx(z1 == complex(3, 4), __LINE__);

	// 6. Test subtraction assignment operator
	z1 -= z2; 
	cout << "Test 6 - Subtraction assignment of complex numbers\n\n";
	assertx(z1 == complex(2, 3), __LINE__);

	// 7. Test multiplication assignment operator
	z1 *= z2;
	cout << "Test 7 - Multiplication assignment of complex numbers\n\n";
	assertx(z1 == complex(-1, 5), __LINE__);

	// 8. Test division assignment operator
	z1 /= z2; 
	cout << "Test 8 - Division assignment of complex numbers\n\n";
	assertx(z1 == complex(2, 3), __LINE__);

	// 9. Test negation of a complex number
	cout << "Test 9 - Negation of complex number\n\n";
	assertx(-z1 == complex(-2, -3), __LINE__);

	// 10. Test complex conjugate
	cout << "Test 10 - Conjugate of complex number\n\n";
	assertx(conj(z1) == complex(2, -3), __LINE__);
